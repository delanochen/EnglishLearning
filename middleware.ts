...
export const config = { matcher: ["/dashboard/:path*", "/admin/:path*", "/family/:path*", "/learn/:path*", "/tasks/:path*", "/plans/:path*", "/reports/:path*", "/placement/:path*", "/notifications/:path*", "/account/:path*", "/api/auth/:path*", "/api/uploads"] };
