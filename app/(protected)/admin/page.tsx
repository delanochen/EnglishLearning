...
export default async function AdminPage() {
  ...
  const links = [["/admin/users","用户管理"],["/admin/families","家庭管理"],["/admin/roles","角色与权限"],["/admin/plans","学习计划"],["/admin/content","课程与内容"],["/admin/content/generate-reading","AI 阅读生成"],["/admin/files","上传文件"],["/admin/logs","系统日志"],["/admin/settings","系统设置"],["/admin/ai","AI 模型"],["/admin/operations","运维与备份"]];
