...
export default async function AdminPage() {
  ...
  const t = english ? { title:"Administration", users:"Users", families:"Families", status:"System status", healthy:"Healthy", center:"Management center", audits:"Recent audit records", empty:"No audit records", links:["Users","Families","Roles & permissions","Learning plans","Content Center","Courses & content","AI reading generation","Uploaded files","System logs","System settings","AI models","Operations & backups"] } : { title:"管理后台", users:"用户", families:"家庭", status:"系统状态", healthy:"正常", center:"管理中心", audits:"最近审计记录", empty:"暂无操作记录", links:["用户管理","家庭管理","角色与权限","学习计划","内容中心","课程与内容","AI 阅读生成","上传文件","系统日志","系统设置","AI 模型","运维与备份"] };
  const paths = ["/admin/users","/admin/families","/admin/roles","/admin/plans","/admin/content-center","/admin/content","/admin/content/generate-reading","/admin/files","/admin/logs","/admin/settings","/admin/ai","/admin/operations"];
