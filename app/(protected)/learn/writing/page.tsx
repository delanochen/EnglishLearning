...
export default async function WritingPage() {
  ...
  const assignmentsRaw = selected ? await db.writingAssignment.findMany({
  ...
  }) : [];const assignments=selectExactLevelItems(assignmentsRaw,selected?.level,item=>item.level);
