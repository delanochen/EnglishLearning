...
export default async function VocabularyPage() {
  ...
  const t = english
    ...
    : { title: "单词学习与复习", help: `每组数量只是自定义学习目标，不是每日上限；完成后仍可继续下一组。难度跟随水平测试结果 ${learner?.cefrLevel?.replace("_", "-") ?? "待测试"}。`,goal:"每组单词数量",save:"更新目标", noZh: "暂无中文解释", empty: "今天暂时没有该等级需要学习或复习的单词。" };
